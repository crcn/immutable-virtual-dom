...
Element.prototype.freezeComponent = function(clazz, options, hydrators) {
  ...
  hydrators.push(new ComponentHydrator(clazz, section, fragment.apply(this, this.childNodes), this.attributes));
...
function ComponentHydrator(clazz, section, childNodes, attributes) {
  this.clazz      = clazz;
...
ComponentHydrator.prototype.hydrate = function(root, bindings) {
  ...
  bindings.push(new this.clazz(this._marker.createSection(root), this.childNodes, this.attributes));
}
